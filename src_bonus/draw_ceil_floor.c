...
//		ray_dir0 = (t_fvector) {(float) cosf(game->player.angle) - cosf(game->player.angle + 33) , sinf(game->player.angle) - sinf(game->player.angle + 33)};
//		ray_dir1 = (t_fvector) {(float) cosf(game->player.angle) + cosf(game->player.angle + 33) , sinf(game->player.angle) + sinf(game->player.angle + 33)};
//
...
//			tex = (t_vector) {(int) (TEXTURE_SIZE * (floor.x - (float) cell.x)) % TEXTURE_SIZE,
//								(int) (TEXTURE_SIZE * (floor.y - (float) cell.y)) % TEXTURE_SIZE};
