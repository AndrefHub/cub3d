...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/09 18:50:22 by lsherry           #+#    #+#             */
/*   Updated: 2022/11/09 18:50:24 by lsherry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	all_button_mouse_actions(t_game *game, t_button *buttons, int size)
{
	...
	while (++c < size)
	{
		if (buttons[c].pos.x <= game->key.mpos.x
			&& game->key.mpos.x < buttons[c].pos.x + buttons[c].size.x
